...
const newsevento = document.querySelector('.container.d-flex.justify-content-center.align-items-center.flex-wrap');
...
async function reservarIngresso(event) {
    try {
        ...
        console.log(novaReserva.event_id)
